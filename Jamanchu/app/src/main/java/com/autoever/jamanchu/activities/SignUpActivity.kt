...
class SignUpActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val editTextPW = findViewById<TextView>(R.id.editTextPassword)
        val editTextNickname = findViewById<TextView>(R.id.editTextNickname)
        val editTextIntroduction = findViewById<TextView>(R.id.editTextIntro)
        val radioGroup = findViewById<RadioGroup>(R.id.radioGroup)
        val spinner = findViewById<Spinner>(R.id.spinner)
        val textViewComplete = findViewById<TextView>(R.id.buttonSignUp)
        ...
        textViewComplete.setOnClickListener {
            ...
            signUp(user, editTextPW.text.toString())
